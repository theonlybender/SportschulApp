...
public class CSatz extends Satz
{
  ...
  /**
   * Feld c07, 5 Bytes, numerisch, Textschl�ssel, Kennzeichnung der Zahlungsart
  ...
  public void write(DataOutputStream dos) throws IOException, DtausException
  {
    ...
    // Feld 4 - Bankleitzahl endbeg�nstigtes Institut / Zahlstelle
    dos.writeBytes(Tool.formatBLZ(cBlzEndbeguenstigt));
    // Feld 5 - Kontonummer �berweisungsempf�nger / Zahlungspflichtiger
  ...
  public String toString()
  {
    String ret = "Satzl�nge=" + this.getSatzlaenge() + ", BLZ erstbeteiligt="
        ...
        + ", Name Empf�nger=" + this.getNameEmpfaenger() + ", Name Empf�nger2="
 ...
 * ���� Revision 1.4 2006/06/05 09:34:36 jost Erweiterungen f. d.
 * DtausDateiWriter Revision 1.3 2006/05/29 16:37:37 jost Anpassungen f�r den
 * Einsatz in Hibiscus Revision 1.2 2006/05/25 20:30:05 jost Alle
 * Erweiterungsteile k�nnen jetzt verarbeitet werden. Revision 1.1 2006/05/24
