...
public class ESatz extends Satz
{
  ...
  public void write(DataOutputStream dos) throws IOException
  {
    ...
    // Feld 8 - Summe der Betr�ge in Euro
  ...
  public String toString()
  {
    return "Satzlaenge=" + eSatzlaenge + ", Satzart=" + eSatzart
        + ", Anzahl C-S�tze=" + eAnzahlC + ", Summe Kontonummern="
        + eSummeKontonummern.toString() + ", Summe Bankleitzahlen="
        + eSummeBankleitzahlen.toString() + ", Summe Betr�ge=" + eSummeBetraege;
  }
}
/*
 * $Log: ESatz.java,v $
 ...
 * Gro�-Kleinschreibung und ���� Revision 1.4 2006/06/14 19:57:05 jost Mehrere
 * logische Dateien k�nnen jetzt ausgegeben werden.
 * 
 * Revision 1.3 2006/06/05 09:35:36 jost Erweiterungen f. d. DtausDateiWriter
 * Revision 1.2 2006/05/29 16:38:21 jost Anpassungen f�r den Einsatz in Hibiscus
 * 
