...
public class EditEventParticipantsPresenter implements Presenter{
	...
	public EditEventParticipantsPresenter(AdminServiceAsync rpcService, HandlerManager eventBus, Display display, String eventID, LocalizationConstants constants) {
