function sportschulapp(){
  ...
  if (!isHostedMode()) {
    try {
      ...
      unflattenKeylistIntoAnswers([$intern_60, $intern_51], $intern_62);
      ...
      unflattenKeylistIntoAnswers([$intern_40, $intern_47], $intern_66);
      unflattenKeylistIntoAnswers([$intern_60, $intern_49], $intern_67);
      unflattenKeylistIntoAnswers([$intern_60, $intern_54], $intern_68);
      unflattenKeylistIntoAnswers([$intern_40, $intern_51], $intern_69);
      unflattenKeylistIntoAnswers([$intern_60, $intern_53], $intern_70);
