function sportschulapp(){
  ...
  if (!isHostedMode()) {
    try {
      ...
      unflattenKeylistIntoAnswers([$intern_60, $intern_52], $intern_62);
      unflattenKeylistIntoAnswers([$intern_60, $intern_54], $intern_63);
