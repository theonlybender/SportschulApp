function sportschulapp(){
  ...
  if (!isHostedMode()) {
    try {
      ...
      unflattenKeylistIntoAnswers([$intern_62, $intern_50], $intern_65);
      unflattenKeylistIntoAnswers([$intern_41, $intern_52], $intern_66);
      unflattenKeylistIntoAnswers([$intern_62, $intern_48], $intern_67);
      unflattenKeylistIntoAnswers([$intern_41, $intern_48], $intern_68);
      unflattenKeylistIntoAnswers([$intern_62, $intern_53], $intern_69);
